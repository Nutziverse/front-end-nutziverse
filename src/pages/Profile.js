														...
														<div className="card-body">
															<div className="row justify-content-center gy-2">
																<div className="col-3 col-sm-6 col-md-4 col-lg-4">
																	<img
																		src="https://cdn-icons-png.flaticon.com/512/822/822133.png"
																		alt="Weight"
																		className="img-fluid"
																	/>
																</div>
													...
													<div className="card border-0 shadow-sm">
														<div className="card-body">
															<div className="row justify-content-center gy-2">
																<div className="col-3 col-sm-6 col-md-4 col-lg-4">
																	<img
																		src="https://cdn-icons-png.flaticon.com/512/4852/4852363.png"
																		alt="activity"
																		className="img-fluid"
																	/>
																</div>
																...
																<div className="col-12">
																	<h6 className="text-primary">
																		{User.aktivitasFisik.keterangan}
																	</h6>
																</div>
															</div>
														</div>
