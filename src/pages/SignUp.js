    ...
    <Layout>
      <div className="container">
        ...
        <div className="row mt-5">
          ...
          <div className="col-6 mt-4">
            <div className="form-group">
              ...
              <select class="form-control form-control-lg mt-2" id="jeniskelamin" placeholder="Jenis Kelamin">
        ...
        <div className="row">
          ...
          <div className="col-6 mt-4">
            <div className="form-group">
              <label for="tanggallahir" style={{ fontSize: "20px" }}>
                Tanggal Lahir
              </label>
        ...
        <div className="row">
          ...
          <div className="row">
            <div className="col-12 mt-5 text-center">
              <button
                type="submit"
                className="btn btn-sm btn-main text-center"
                style={{ backgroundColor: "#067cc6", fontSize: "20px", boxShadow: "0 8px 16px 0 rgba(0,0,0,0.05), 0 6px 20px 0 rgba(0,0,0,0.19)", borderRadius: "8px", padding: "15px 18px;", color: "white", height: "50px", width: "500px" }}
              >
                Daftar
              </button>
            </div>
